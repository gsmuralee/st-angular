...
var nestedApp = angular.module("nestedApp", [])
...
nestedApp.controller("firstControllerScope",["$scope", firstControllerScope]).
controller("secondControllerScope",["$scope", secondControllerScope]).
controller("thirdControllerScope",["$scope", thirdControllerScope]).
controller("firstControllerObj",["$scope", firstControllerObj]).
controller("secondControllerObj",["$scope", secondControllerObj]).
controller("thirdControllerObj",["$scope", thirdControllerObj])